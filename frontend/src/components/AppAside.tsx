        ...
        <CTabPane visible={activeKey === 1}>
          <CListGroup flush>
            ...
            <CListGroupItem href="#" className="border-start-4 border-start-warning">
              ...
              <div>
                Reunião com <strong>Renata</strong>
              </div>
              <small className="text-body-secondary me-3">
                <CIcon icon={cilCalendar} /> 13:00 - 15:00
              </small>
              <small className="text-body-secondary">
                <CIcon icon={cilLocationPin} /> Sorocaba - SP
              </small>
            </CListGroupItem>
            <CListGroupItem href="#" className="border-start-4 border-start-info">
              <CAvatar src={avatar4.src} size="lg" className="float-end" />
              <div>
                Chamada com <strong>Megan</strong>
              </div>
              <small className="text-body-secondary me-3">
                <CIcon icon={cilCalendar} /> 16:00 - 17:00
              </small>
              <small className="text-body-secondary">
                <CIcon icon={cibSkype} /> Online
              </small>
            </CListGroupItem>
            ...
            <CListGroupItem href="#" className="border-start-4 border-start-danger">
              <div>
                Novo projeto - <strong>Prazo Final</strong>
              </div>
              <small className="text-body-secondary me-3">
                <CIcon icon={cilCalendar} /> 22:00 - 23:00
              </small>
              <small className="text-body-secondary">
                <CIcon icon={cilHome} /> FreedomIT
              </small>
            ...
            <CListGroupItem href="#" className="border-start-4 border-start-primary border-bottom">
              <div>
                <strong>Reunião Semanal</strong>
              </div>
              <small className="text-body-secondary me-3">
                <CIcon icon={cilCalendar} /> 16:00 - 18:00
              </small>
              <small className="text-body-secondary">
                <CIcon icon={cilHome} /> FreedomIT
              </small>
