    ...
    <CDropdown variant="nav-item" alignment="end">
      ...
      <CDropdownMenu className="py-0">
        <CDropdownHeader className="bg-body-secondary text-body-secondary fw-semibold rounded-top mb-2">
          Você tem {itemsCount} tarefas pendentes
        </CDropdownHeader>
        <CDropdownItem className="d-block py-2">
          <div className="d-flex justify-content-between mb-1">
            <div className="small">Atualizar Salarios</div>
        ...
        <CDropdownItem className="d-block py-2">
          <div className="d-flex justify-content-between mb-1">
            <div className="small">Relatório de Vendas</div>
        ...
        <CDropdownItem className="d-block py-2">
          <div className="d-flex justify-content-between mb-1">
            <div className="small">Emissão Notas Fiscais</div>
        ...
        <CDropdownItem className="d-block py-2">
          <div className="d-flex justify-content-between mb-1">
            <div className="small">Pagar Contas</div>
        ...
        <CDropdownItem className="d-block py-2">
          <div className="d-flex justify-content-between mb-1">
            <div className="small">Pagar Salarios</div>
